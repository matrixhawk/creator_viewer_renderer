<template>
  <svg :fill="computedColor" :style="{ width: computedSize, height: computedSize }" viewBox="0 0 16 16"
    xmlns="http://www.w3.org/2000/svg">
    <path d="M2 2H4.4V4.4H2V2Z"></path>
    <path d="M6.8 2H9.2V4.4H6.8V2Z"></path>
    <path d="M11.6 2H14V4.4H11.6V2Z"></path>
    <path d="M4.4 4.4H6.8V6.8H4.4V4.4Z"></path>
    <path d="m9.2 4.4h2.4v2.4h-2.4v-2.4"></path>
    <path d="M2 6.8H4.4V9.2H2V6.8Z"></path>
    <path d="m6.8 6.8h2.4v2.4h-2.4v-2.4"></path>
    <path d="M11.6 6.8H14V9.2H11.6V6.8Z"></path>
    <path d="m4.4 9.2h2.4v2.4h-2.4v-2.4"></path>
    <path d="m9.2 9.2h2.4v2.4h-2.4v-2.4"></path>
    <path d="M2 11.6H4.4V14H2V11.6Z"></path>
    <path d="m6.8 11.6h2.4v2.4h-2.4v-2.4"></path>
    <path d="M11.6 11.6H14V14H11.6V11.6Z"></path>
  </svg>
</template>
